...
public class CreateIcoSphere : ScriptableWizard
{
    ...
    public static Mesh CreateMySphere(int recursionLevel, float radius)
    {
        ...
        MeshRenderer renderer = (MeshRenderer)sphere.AddComponent(typeof(MeshRenderer));
        renderer.sharedMaterial = new Material(Shader.Find("VertexColored"));
        ...
        {
            Vector3 unitVector = mesh.vertices[i].normalized;
